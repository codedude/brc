...
> On my MacbookPro M2, 32Go of RAM, 12 cores, it uses only 55Mo of RAM (2Mo chunk read and 24 threads), and takes only 4 seconds (15Go file size, 1 billion rows, 8926 unique stations)
...
go build . && ./brc && go test -run TestBigProf -cpuprofile cpu.prof -memprofile mem.prof -bench . && pprof -web brc cpu.prof
```
